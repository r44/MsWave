...
class root:
    ...
    def __init__(self, k, query):
        ...
        #self.pivot = [T*3/4+T/16*i for i in range(20) if T*3/4+T/16*i <= T] # Exp for 5.22, part 1.
        self.pivot = [T/4+T/16*i for i in range(20) if T/4+T/16*i <= T]     # Exp for 5.22, part 2.
